class ThemeInstallsController < ShopifyApp::AuthenticatedController
  ...
  def create
    ...
    respond_to do |format|
      if @theme_install.save
        format.html { redirect_to theme_install_url, notice: 'Theme install was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to theme_install_url, notice: 'Theme install was successfully destroyed.' }
